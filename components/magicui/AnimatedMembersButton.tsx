...
export function AnimatedMembersButton() {
  return (
    <div className='z-10 flex items-center justify-center'>
      ...
      >
        <AnimatedShinyText className='flex items-center justify-center px-3 py-2 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400'>
